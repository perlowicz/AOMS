package com.example.aoms.database.user.event.listener;

import com.example.aoms.database.user.dto.UserDto;
import com.example.aoms.database.user.event.RegistrationCompleteEvent;
import com.example.aoms.database.user.service.UserService;
...
public class RegistrationCompleteEventListener implements ApplicationListener<RegistrationCompleteEvent> {
    ...
    public void onApplicationEvent(RegistrationCompleteEvent event) {
        ...
        String url = event.getApplicationUrl() + "/register/verifyEmail?token=" + dto.getToken();
