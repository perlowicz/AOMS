...
import com.example.aoms.database.user.exception.UserAlreadyExistsException;
...
import com.example.aoms.database.user.entity.User;
import com.example.aoms.database.user.exception.UserNotFoundException;
import com.example.aoms.database.user.mappers.UserMapper;
...
import static com.example.aoms.database.user.mappers.UserMapper.mapDtoToEntity;
import static com.example.aoms.database.user.mappers.UserMapper.mapEntityToDto;
